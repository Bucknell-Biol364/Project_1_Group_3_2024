...
1. To be able to explore data within a dataset based on the data type               to be able to convert variables into different type
...
#Filtering Data
Besides dropping nas, using the filter function can be another strategy to create clean datasets and eliminate irrelevant information. 
...
After all of that complicated and scary data exploration and analytics, you might still have questions about the data set. filter() is a great code you can use to filter out the data to create a subset of variables appropriate to analyze your remaining questions. It will eliminate rows (NOT columns) that do not contain the arguments you provide.
...
You can use == to say "equals", and "!=" to say do not include. 
